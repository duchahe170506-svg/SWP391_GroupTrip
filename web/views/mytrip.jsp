...
.card{background:#fff;border:1px solid #e5e7ee;border-radius:12px;padding:20px;margin-bottom:16px}
.trip-list{display:flex;flex-direction:column;gap:14px}
.btn{padding:8px 12px;border-radius:8px;border:1px solid #ccc;text-decoration:none;color:#333;background:#eee}
            ...
            <c:forEach var="t" items="${leaderTrips}">
                <div class="card">
                    ...
                    <div class="actions">
                        <a class="btn primary" 
   <a class="btn primary" 
   href="<c:url value='/activities'>
            <c:param name='tripId' value='${t.tripId}'/>
        </c:url>">
   Xem 
</a>
</a>
